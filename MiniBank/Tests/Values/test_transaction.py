...
class TestTransaction(unittest.TestCase):
    def setUp(self):
        self.deposit = Transaction("deposit", 5.5, 1)
        self.withdraw = Transaction("withdraw", 5.5, 2)

    def test_eq(self):
        self.assertTrue(self.deposit == Transaction("deposit", 5.5, 1))
    ...
    def test_dict(self):
        tdict = {'kind': "deposit", 'amount':5.5, 'transaction_id':1}
